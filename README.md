...
4. You can create action sets to assign actions globally or on a per app basis. Each set has its own unique activation settings, allowing you to create multiple sets for global use or per app.
